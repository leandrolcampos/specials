...
fn _fori_loop_impl[
    ...
    Currently, Mojo does not support passing the index of a conventional for loop to
    a function as a parameter. For instance, the code below would not work here:
...
fn fori_loop[
    ...
    Parameters:
        ...
        body_func: The function to apply at each iteration. The function should take
            a single Int parameter and does not return a value.
